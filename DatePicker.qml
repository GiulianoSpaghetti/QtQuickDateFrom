        ...
        Column {
            Item { // month year header
                ...
                Text { // month year
                    ...
                    text: [qsTr('January'), qsTr('February'), qsTr('March'), qsTr('April'), qsTr('May'), qsTr('June'),
                           qsTr('July'), qsTr('August'), qsTr('September'), qsTr('October'), qsTr('November'), qsTr('December')][month] + ' ' + year
                ...
                Repeater {
                    ...
                    delegate: Rectangle { // index is 0 to 48
                        ...
                        Text {
                            ...
                            text: {
                                if(day < 0)                                               [qsTr('Su'), qsTr('Mo'), qsTr('Tu'), qsTr('We'), qsTr('Th'), qsTr('Fr'), qsTr('Sa')][index] // Su-Sa
